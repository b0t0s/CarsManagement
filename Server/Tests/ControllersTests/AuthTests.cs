...
public class AuthTests
{
    ...
    public async Task Login_ValidCredentials_ReturnsLoginSuccessful()
    {
        ...
        var controller = new AuthController(mockLogger.Object, mockRepository.Object, mockMapper.Object,
            mockOptions.Object);
        ...
        mockRepository.Setup(repo => repo.GetItems())
            .Returns(new List<ManagerModel>
                { new() { AccountName = username, PasswordHash = hashedPassword } }.ToList());
